...
**ВАЖНО:** Текущая реализация использует простое сравнение паролей для демонстрации. В продакшене настоятельно рекомендуется:
- Использовать bcrypt для хеширования паролей
- Хранить пользователей в базе данных
- Реализовать правильную систему управления пользователями
